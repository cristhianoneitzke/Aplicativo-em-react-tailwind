    ...
    >
      <div
        ...
        <ul className="mt-10">
          ...
          <li>
            <Link to="/cadastroproduto" className="block text-blue-600 p-3 hover:bg-blue-400 hover:text-white transition-all" onClick={closeSidebar}>Cadastrar produto</Link>
          </li>
          <li>
